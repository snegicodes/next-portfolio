...
const projects = [
  {
    ...
    description:
      "Your quiet AI security app that watches through your webcam and sends alerts the moment someone is detected. No fuss, just safety.",
    image: "/14.png",
    github: "https://github.com/snegicodes/Silent-Sentinel",
    link: "https://snegicodes-thief-detection.vercel.app/",
  },
  {
    name: "BookEase",
    description:
      "A scheduling application designed to allow users to create events and meetings, set their availability and let others book these events.",
    image: "/13.png",
    github: "https://github.com/snegicodes/BookEase",
    link: "https://snegicodes-bookease.vercel.app/",
  },
  {
    name: "Netflix GPT",
    description:
